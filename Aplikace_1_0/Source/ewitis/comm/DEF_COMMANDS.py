...
DEF_COMMANDS = {
            ...
            "GET_DIAGNOSTIC"            : {'cmd':0x08,  'length':2,     'blackbox': True,    'terminal': True},                                      
            "GET_CALIBRATION_DATA"      : {'cmd':0x0F,  'length':0,     'blackbox': True,    'terminal': True},                                      
            ...
            "CLEAR_DIAGNOSTIC"          : {'cmd':0x09,  'length':2,     'blackbox': True,    'terminal': True},
            "START_CALIBRATION_TIME"    : {'cmd':0x0C,  'length':0,     'blackbox': True,    'terminal': True},
            "END_CALIBRATION_TIME"      : {'cmd':0x0D,  'length':0,     'blackbox': True,    'terminal': True},
            "SET_CALIBRATION"           : {'cmd':0x0E,  'length':4,     'blackbox': True,    'terminal': True},                                                  
            "SET_BACKLIGHT"             : {'cmd':0x10,  'length':1,     'blackbox': True,    'terminal': True},                                      
            "SET_SPEAKER"               : {'cmd':0x11,  'length':3,     'blackbox': True,    'terminal': True},                                      
            "SET_TIME"                  : {'cmd':0x12,  'length':7,     'blackbox': True,    'terminal': True},                                      
            "SET_LANGUAGE"              : {'cmd':0x14,  'length':1,     'blackbox': True,    'terminal': True},                                      
            ...
            "ENABLE_START_CELL"         : {'cmd':0x41,  'length':0,     'blackbox': True,    'terminal': True},
            "ENABLE_FINISH_CELL"        : {'cmd':0x42,  'length':0,     'blackbox': True,    'terminal': True},
            ...
            "SET_TAGS_READING"          : {'cmd':0x45,  'length':1,     'blackbox': True,    'terminal': True},                                                                                                    
            "GET_ACTUAL_RACE_TIME"      : {'cmd':0x46,  'length':4,     'blackbox': True,    'terminal': True}                                                                                                    
