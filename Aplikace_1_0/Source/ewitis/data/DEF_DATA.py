...
DEF_DATA = {
        ...
        "export"              : {"name"     : "export",
                                "permanent": True,                                
                                "GET_SET"  : {"value": {
                                                        "sorted": ["order1", "order2", "order3", "nr", "name", "category", "year", "club", "sex", "option1","option2","option3", "option4", "gap", "points1","points2","points3","time1","lap1","time2","lap2","time3","lap3"],
                                                        "names":  {                                                
                                                                "order1"            : u"pořadí",
                                                                "order2"            : u"pořadí",
                                                                "order3"            : u"pořadí",
